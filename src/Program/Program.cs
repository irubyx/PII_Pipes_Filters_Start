...
namespace CompAndDel
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Ejercicio 4 (incompleta)
            FilterConditional xd = new FilterConditional();
            ...
            PipeConditional ola = new PipeConditional(xd, negative1, twitter1, xd.Indicator);
            PipeSerial nueva = new PipeSerial(new FilterGreyscale(), ola);
            nueva.Send(picture);
        }
    }
}
